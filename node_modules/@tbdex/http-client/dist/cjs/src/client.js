import { RequestError, ResponseError, InvalidDidError, MissingServiceEndpointError, RequestTokenMissingClaimsError, RequestTokenAudienceMismatchError, RequestTokenSigningError, RequestTokenVerificationError } from './errors/index.js';
import { resolveDid, Resource, Message } from '@tbdex/protocol';
...
export class TbdexHttpClient {
    ...
    static async sendMessage(opts) {
        const { message } = opts;
        const jsonMessage = message instanceof Message ? message.toJSON() : message;
    ...
    */
    static async verifyRequestToken(params) {
        ...
        console.log("[TBD Server] OTHER Verify Request Token: ", params)
