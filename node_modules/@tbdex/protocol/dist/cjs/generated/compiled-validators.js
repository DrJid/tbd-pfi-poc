"use strict";
export var close = validate10;
var schema11 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://tbdex.dev/close.schema.json", "type": "object", "additionalProperties": false, "properties": { "reason": { "type": "string" } } };
...
export var definitions = validate11;
var schema12 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://tbdex.dev/definitions.json", "type": "object", "definitions": { "did": { "type": "string", "pattern": "^did:([a-z0-9]+):((?:(?:[a-zA-Z0-9._-]|(?:%[0-9a-fA-F]{2}))*:)*((?:[a-zA-Z0-9._-]|(?:%[0-9a-fA-F]{2}))+))((;[a-zA-Z0-9_.:%-]+=[a-zA-Z0-9_.:%-]*)*)(/[^#?]*)?([?][^#]*)?(#.*)?$" }, "decimalString": { "type": "string", "pattern": "^([0-9]+[.][0-9]+)$" } } };
...
export var offering = validate12;
var schema13 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://tbdex.dev/offering.schema.json", "definitions": { "CurrencyDetails": { "type": "object", "additionalProperties": false, "properties": { "currencyCode": { "type": "string", "description": "ISO 3166 currency code string" }, "minAmount": { "$ref": "definitions.json#/definitions/decimalString", "description": "Minimum amount of currency that can be requested" }, "maxAmount": { "$ref": "definitions.json#/definitions/decimalString", "description": "Maximum amount of currency that can be requested" } }, "required": ["currencyCode"] }, "PaymentMethod": { "type": "object", "additionalProperties": false, "properties": { "kind": { "type": "string", "description": "The type of payment method. e.g. BITCOIN_ADDRESS, DEBIT_CARD, etc." }, "requiredPaymentDetails": { "type": "object", "description": "A JSON Schema containing the fields that need to be collected in order to use this payment method" } }, "required": ["kind"] } }, "type": "object", "properties": { "additionalProperties": false, "description": { "type": "string", "description": "Brief description of what is being offered." }, "payoutUnitsPerPayinUnit": { "type": "string", "description": "Number of payout currency units for one payin currency unit (i.e 290000 USD for 1 BTC)" }, "payinCurrency": { "$ref": "#/definitions/CurrencyDetails" }, "payoutCurrency": { "$ref": "#/definitions/CurrencyDetails" }, "payinMethods": { "type": "array", "items": { "$ref": "#/definitions/PaymentMethod" } }, "payoutMethods": { "type": "array", "items": { "$ref": "#/definitions/PaymentMethod" } }, "requiredClaims": { "type": "object", "description": "PresentationDefinition that describes the credential(s) the PFI requires in order to provide a quote." } }, "required": ["description", "payoutUnitsPerPayinUnit", "payinCurrency", "payoutCurrency", "payinMethods", "payoutMethods", "requiredClaims"] };
var schema17 = { "type": "object", "additionalProperties": false, "properties": { "kind": { "type": "string", "description": "The type of payment method. e.g. BITCOIN_ADDRESS, DEBIT_CARD, etc." }, "requiredPaymentDetails": { "type": "object", "description": "A JSON Schema containing the fields that need to be collected in order to use this payment method" } }, "required": ["kind"] };
var schema14 = { "type": "object", "additionalProperties": false, "properties": { "currencyCode": { "type": "string", "description": "ISO 3166 currency code string" }, "minAmount": { "$ref": "definitions.json#/definitions/decimalString", "description": "Minimum amount of currency that can be requested" }, "maxAmount": { "$ref": "definitions.json#/definitions/decimalString", "description": "Maximum amount of currency that can be requested" } }, "required": ["currencyCode"] };
var schema15 = { "type": "string", "pattern": "^([0-9]+[.][0-9]+)$" };
                    ...
                    if (valid0) {
                        ...
                        if (valid0) {
                            if (data.payinCurrency !== undefined) {
                                var _errs5 = errors;
                                if (!(validate13(data.payinCurrency, { instancePath: instancePath + "/payinCurrency", parentData: data, parentDataProperty: "payinCurrency", rootData: rootData }))) {
                            ...
                            if (valid0) {
                                if (data.payoutCurrency !== undefined) {
                                    var _errs6 = errors;
                                    if (!(validate13(data.payoutCurrency, { instancePath: instancePath + "/payoutCurrency", parentData: data, parentDataProperty: "payoutCurrency", rootData: rootData }))) {
                                        vErrors = vErrors === null ? validate13.errors : vErrors.concat(validate13.errors);
                                        errors = vErrors.length;
                                    }
                                                                ...
                                                                if (_errs12 === errors) {
                                                                    ...
                                                                    if (valid3) {
                                                                        if (data6.requiredPaymentDetails !== undefined) {
                                                                            var data8 = data6.requiredPaymentDetails;
                                                                            var _errs15 = errors;
                                    ...
                                    if (valid0) {
                                                                    ...
                                                                    if (_errs22 === errors) {
                                                                        ...
                                                                        if (valid6) {
                                                                            if (data10.requiredPaymentDetails !== undefined) {
                                                                                var data12 = data10.requiredPaymentDetails;
                                                                                var _errs25 = errors;
                                        ...
                                        if (valid0) {
                                            if (data.requiredClaims !== undefined) {
                                                var data13 = data.requiredClaims;
                                                var _errs27 = errors;
            ...
            if ((((data.metadata === undefined) && (missing0 = "metadata")) || ((data.data === undefined) && (missing0 = "data"))) || ((data.signature === undefined) && (missing0 = "signature"))) {
                ...
                if (_errs1 === errors) {
                    if (data.metadata !== undefined) {
                        var _errs2 = errors;
                        if (!(validate17(data.metadata, { instancePath: instancePath + "/metadata", parentData: data, parentDataProperty: "metadata", rootData: rootData }))) {
...
export var order = validate19;
var schema24 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://tbdex.dev/order.schema.json", "type": "object", "additionalProperties": false, "properties": {} };
...
export var orderstatus = validate20;
var schema25 = { "$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://tbdex.dev/orderstatus.schema.json", "type": "object", "required": ["orderStatus"], "additionalProperties": false, "properties": { "orderStatus": { "type": "string" } } };
            ...
            if (((data.currencyCode === undefined) && (missing0 = "currencyCode")) || ((data.amount === undefined) && (missing0 = "amount"))) {
                ...
                for (var key0 in data) {
                    if (!((((key0 === "currencyCode") || (key0 === "amount")) || (key0 === "fee")) || (key0 === "paymentInstruction"))) {
                        validate22.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                        ...
                        if (valid0) {
                            ...
                            if (valid0) {
                                if (data.paymentInstruction !== undefined) {
                                    var data3 = data.paymentInstruction;
                                    var _errs10 = errors;
                                    var _errs11 = errors;
                                    if (errors === _errs11) {
                                        if (data3 && typeof data3 == "object" && !Array.isArray(data3)) {
                ...
                if (_errs1 === errors) {
                    ...
                    if (valid0) {
                        if (data.payin !== undefined) {
                            var _errs4 = errors;
                            if (!(validate22(data.payin, { instancePath: instancePath + "/payin", parentData: data, parentDataProperty: "payin", rootData: rootData }))) {
                        ...
                        if (valid0) {
                            if (data.payout !== undefined) {
                                var _errs5 = errors;
                                if (!(validate22(data.payout, { instancePath: instancePath + "/payout", parentData: data, parentDataProperty: "payout", rootData: rootData }))) {
                                    vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
                                    errors = vErrors.length;
                                }
                                var valid0 = _errs5 === errors;
            ...
            if ((((data.metadata === undefined) && (missing0 = "metadata")) || ((data.data === undefined) && (missing0 = "data"))) || ((data.signature === undefined) && (missing0 = "signature"))) {
                ...
                for (var key0 in data) {
                    if (!(((key0 === "metadata") || (key0 === "data")) || (key0 === "signature"))) {
                        validate25.errors = [{ instancePath: instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" }];
                        return false;
                        break;
                    }
                }
                                                ...
                                                if (_errs13 === errors) {
                                                    ...
                                                    if (valid4) {
                                                        if (data5.paymentDetails !== undefined) {
                                                            var data7 = data5.paymentDetails;
                                                            var _errs16 = errors;
                                                    ...
                                                    if (_errs21 === errors) {
                                                        ...
                                                        if (valid6) {
                                                            if (data8.paymentDetails !== undefined) {
                                                                var data10 = data8.paymentDetails;
                                                                var _errs24 = errors;
                                                                if (!(data10 && typeof data10 == "object" && !Array.isArray(data10))) {
