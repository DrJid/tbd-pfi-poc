 ...
 * @beta
 */
export type NewMessage<T extends MessageKind> = Omit<MessageModel<T>, 'signature'> & {
    signature?: string;
};
/**
 ...
 * @beta
 */
export type NewResource<T extends ResourceKind> = Omit<ResourceModel<T>, 'signature'> & {
    signature?: string;
};
/**
