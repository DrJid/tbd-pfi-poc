...
export class Resource {
    ...
    */
     ...
     */
    static async verify(resource) {
        let jsonResource = resource instanceof Resource ? resource.toJSON() : resource;
     ...
     * unsigned Resources.
     */
    static validateData(kind, resourceData) {
