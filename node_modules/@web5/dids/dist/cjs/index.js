...
__export(utils_exports, {
  ...
  isVerificationMethod: () => isVerificationMethod,
  parseDid: () => parseDid
});
...
var DidDhtMethod = class {
  ...
  static create(options) {
    return __awaiter2(this, void 0, void 0, function* () {
      ...
      if (publish) {
        yield this.publish({ identityKey, didDocument: document2 });
      }
      return {
        did: document2.id,
        document: document2,
  ...
  static publish({ didDocument, identityKey }) {
    return __awaiter2(this, void 0, void 0, function* () {
      const publicCryptoKey = yield import_crypto4.Jose.jwkToCryptoKey({ key: identityKey.publicKeyJwk });
      const privateCryptoKey = yield import_crypto4.Jose.jwkToCryptoKey({ key: identityKey.privateKeyJwk });
...
var DidResolver = class {
  ...
  dereference({ didUrl }) {
    return __awaiter8(this, void 0, void 0, function* () {
      const { didDocument, didResolutionMetadata = {}, didDocumentMetadata = {} } = yield this.resolve(didUrl);
      ...
      const idSet = /* @__PURE__ */ new Set([didUrl, parsedDid.fragment, `#${parsedDid.fragment}`]);
      let didResource;
